...
Below is a table of all supported language features.

{:.table}
| Feature      | Method | Parameters | Response |
|:------------ |:-------------------------|:----------|:---------|
| <a href="/language-server-protocol/specifications/lsp/3.17/features/completion" class="anchor">Completion</a>   | `textDocument/completion` | (`CompletionParams`) | `CompletionList` or `CompletionItem[]` |
|  | `completionItem/resolve` | (`CompletionItem`) | `CompletionItem` |
| <a href="/language-server-protocol/specifications/lsp/3.17/features/hover" class="anchor">Hover</a> | `textDocument/hover` | (`HoverParams`) | `Hover` |
